# Google Style Guide Compliance and Doxygen
...
The code in the src directory is _somewhat_ style-compliant.
...
**Run on your local machine** - You could install from instructions above, but just in case
